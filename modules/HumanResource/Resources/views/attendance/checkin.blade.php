...
@section('title', localize('check_in'))
@section('content')
    @include('humanresource::attendance_header')
    <div class="card mb-4 fixed-tab-body">
        @include('backend.layouts.common.validation')
        @include('backend.layouts.common.message')
        <input type="hidden" id="checkInStore" value="{{ route('attendances.checkIn.store') }}">
        <div class="card-header">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h6 class="fs-17 fw-semi-bold mb-0">{{ localize('check_in') }}</h6>
                </div>
                <div class="text-end">
                    <div class="actions">
        ...
        <div class="card-body">
            <form action="{{ route('attendances.checkIn.store') }}" method="GET">
                <div class="row">
                    <div class="col-md-6">
